...
class DaysControllerTest < ActionController::TestCase
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post :create, day: { dailyworkhours: @day.dailyworkhours, date: @day.date, day: @day.day, timein: @day.timein, timeout: @day.timeout, totalamount: @day.totalamount }
    end
  ...
  test "should update day" do
    put :update, id: @day, day: { dailyworkhours: @day.dailyworkhours, date: @day.date, day: @day.day, timein: @day.timein, timeout: @day.timeout, totalamount: @day.totalamount }
    assert_redirected_to day_path(assigns(:day))
  end
